# Generated by Django 3.1.2 on 2021-06-06 12:10
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='song',
            name='album',
            field=models.ImageField(blank=True, null=True, upload_to=music.models.album_path, verbose_name='Poster'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('film', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='music.song')),
            ],
            options={
